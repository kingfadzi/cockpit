...
export const mockApi = {
  ...
  getRiskItems: async (categoryId: string, page = 1, pageSize = 10): Promise<RiskItemsResponse> => {
    ...
    const allItems: Record<string, RiskItem[]> = {
      ...
      'rc_security_apm100001': [
        {
          riskItemId: 'ri_apm_auth_001',
          riskCategoryId: 'rc_security_apm100001',
          appId: 'APM100001',
          fieldKey: 'authentication_mechanism',
          fieldLabel: 'Authentication Mechanism',
          title: 'Weak authentication mechanism in use',
          hypothesis: 'Application may be using basic authentication instead of modern auth',
          condition: 'IF basic authentication is used without MFA',
          consequence: 'THEN user accounts are vulnerable to credential-based attacks',
          severity: 'critical',
          status: 'PENDING_SME_REVIEW',
          assignedSme: 'security_sme_001',
          raisedBy: 'SYSTEM_AUTO_CREATION',
          triggeringEvidenceId: 'ev_apm_001',
          evidenceCount: 2,
          evidenceIds: ['ev_apm_001', 'ev_apm_002'],
          openedAt: '2025-01-15T10:00:00Z',
        ...
        {
          riskItemId: 'ri_apm_encryption_001',
          riskCategoryId: 'rc_security_apm100001',
          appId: 'APM100001',
          fieldKey: 'encryption_at_rest',
          fieldLabel: 'Encryption at Rest',
          title: 'Missing encryption for sensitive data',
          hypothesis: 'PII and financial data may not be encrypted at rest',
          condition: 'IF sensitive data is stored without encryption',
          consequence: 'THEN data breaches could expose customer information',
          severity: 'critical',
          status: 'PENDING_SME_REVIEW',
          assignedSme: 'security_sme_001',
          raisedBy: 'compliance_team',
          triggeringEvidenceId: 'ev_apm_003',
          evidenceCount: 1,
          evidenceIds: ['ev_apm_003'],
          openedAt: '2025-01-16T09:00:00Z',
          assignedAt: '2025-01-16T09:05:00Z',
          createdAt: '2025-01-16T09:00:00Z',
          updatedAt: '2025-01-19T16:00:00Z',
        ...
        {
          riskItemId: 'ri_apm_vuln_001',
          riskCategoryId: 'rc_security_apm100001',
          appId: 'APM100001',
          fieldKey: 'vulnerability_scanning',
          fieldLabel: 'Vulnerability Scanning',
          title: 'Irregular vulnerability scanning',
          hypothesis: 'Application may not be scanned regularly for vulnerabilities',
          condition: 'IF vulnerability scans are not run weekly',
          consequence: 'THEN known vulnerabilities may remain unpatched',
          severity: 'high',
          status: 'PENDING_SME_REVIEW',
          assignedSme: 'security_sme_001',
          raisedBy: 'SYSTEM_AUTO_CREATION',
          triggeringEvidenceId: 'ev_apm_004',
          evidenceCount: 1,
          evidenceIds: ['ev_apm_004'],
          openedAt: '2025-01-17T11:00:00Z',
          assignedAt: '2025-01-17T11:05:00Z',
      ...
      'rc_availability_apm100001': [
        {
          riskItemId: 'ri_apm_monitoring_001',
          riskCategoryId: 'rc_availability_apm100001',
          appId: 'APM100001',
          fieldKey: 'monitoring_slos',
          fieldLabel: 'Monitoring SLOs',
          title: 'Insufficient monitoring coverage',
          hypothesis: 'Application monitoring may not cover all critical services',
          condition: 'IF monitoring does not cover all critical endpoints',
          consequence: 'THEN outages may go undetected',
          severity: 'medium',
          status: 'PENDING_SME_REVIEW',
          assignedSme: 'service_transition_sme_001',
          raisedBy: 'sre_team',
          triggeringEvidenceId: 'ev_apm_005',
          evidenceCount: 2,
          evidenceIds: ['ev_apm_005', 'ev_apm_006'],
          openedAt: '2025-01-18T14:00:00Z',
          assignedAt: '2025-01-18T14:05:00Z',
          createdAt: '2025-01-18T14:00:00Z',
        ...
        {
          riskItemId: 'ri_apm_dr_001',
          riskCategoryId: 'rc_availability_apm100001',
          appId: 'APM100001',
          fieldKey: 'disaster_recovery_rto',
          fieldLabel: 'Disaster Recovery RTO',
          title: 'DR RTO exceeds target',
          hypothesis: 'Disaster recovery time may exceed business requirements',
          condition: 'IF RTO exceeds 4 hours',
          consequence: 'THEN business operations may be severely impacted during outages',
          severity: 'medium',
          status: 'PENDING_SME_REVIEW',
          assignedSme: 'service_transition_sme_001',
          raisedBy: 'SYSTEM_AUTO_CREATION',
          triggeringEvidenceId: 'ev_apm_007',
          evidenceCount: 1,
          evidenceIds: ['ev_apm_007'],
          openedAt: '2025-01-19T10:00:00Z',
          assignedAt: '2025-01-19T10:05:00Z',
